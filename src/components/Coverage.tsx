const lanes = [
  {
    from: "Midwest",
    to: "Northeast",
    detail: "IL, IN, OH → NY, PA, NJ, MA",
  },
  {
    from: "Midwest",
    to: "Southeast",
    detail: "IL, IN → TN, GA, FL, SC",
  },
  {
    from: "Midwest",
    to: "West Coast",
    detail: "IL, MO → CA, OR, WA",
  },
  {
    from: "Midwest",
    to: "Southwest",
    detail: "IL → TX, AZ, NV, NM",
  },
  {
    from: "Midwest",
    to: "Northwest",
    detail: "IL → CO, ID, MT, WY",
  },
  {
    from: "Southeast",
    to: "Northeast",
    detail: "FL, GA → NY, MA, CT",
  },
];
              ...
              <div className="grid gap-3">
                {lanes.map((lane) => (
                  <div
                    ...
                    className="bg-white/5 border border-white/10 rounded-xl px-5 py-3.5 flex items-center justify-between"
                  >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {regions.map((r) => (
                  <span
                    key={r}
                    className="bg-white/10 border border-white/15 text-navy-100 font-inter text-sm px-3 py-1.5 rounded-full"
                  >
                    {r}
                  </span>
                ))}
